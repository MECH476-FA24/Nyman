...
summary <- airlift_data %>%
  ...
  rename('mean' = 'mean(mass_mg)',                            #XL: Additionally, please pay attention to the  **precision**. Use the `round()` function to avoid reporting more than 0.1 $\mu g$ of precision (or 0.0001 $mg$). For example, round(mass_g, digits = 6). Same for Question 3. 
