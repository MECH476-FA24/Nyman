...
print(fails)
PA_data_merged <- na.omit(PA_data_merged, c(1132,5274,5361))
```
...
``` {r plots}
ggplot(PA_data_merged, aes(y = pm2_5_atm, fill = sensor_ID)) +
  geom_boxplot() +
  theme_minimal() +
  labs(y = "Concentration of Particulate (µ/m^3)", title = "Boxplot of Concentration of Particulate from different sensors")
